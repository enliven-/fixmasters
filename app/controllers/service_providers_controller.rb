class ServiceProvidersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @service_provider.save
        format.html { redirect_to @service_provider, notice: 'ServiceProvider was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @service_provider.update(ServiceProvider_params)
        format.html { redirect_to @service_provider, notice: 'ServiceProvider was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to service_providers_url, notice: 'ServiceProvider was successfully destroyed.' }
